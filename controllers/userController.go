...
import (
	helper "github.com/codeeHunter/golang-jwt/helpers"
	// "github.com/codeeHunter/golang-jwt/models"
	"strconv"
	...
	"github.com/codeeHunter/golang-jwt/database"
	"github.com/codeeHunter/golang-jwt/models"
...
func SignUp() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			log.Panic(err)
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured while for the email"})
		}
		...
		if err != nil {
			log.Panic(err)
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured while for the phone"})
		}
